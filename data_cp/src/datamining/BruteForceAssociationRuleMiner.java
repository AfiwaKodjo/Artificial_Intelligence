...
public class BruteForceAssociationRuleMiner extends AbstractAssociationRuleMiner {
    ...
    //Méthode retournant les sous-ensembles d'un ensemble sans lui même et l'ensemble vide
    ...
    //Méthode retournant l'ensemble des règles d'association de fréquence et de confiance supérieures aux seuils
    @Override
